...
function initFeedback() {
  ...
  overlay.innerHTML = `
    <div id="fb-modal">
      <div id="fb-form-view">
        <h3>Send Feedback</h3>
        <p class="sub">Help us improve Tactics 2 Talent — every note goes directly to the team.</p>
        <div class="fb-cats">
...
function submitFeedback() {
  ...
  const subject = encodeURIComponent(`Tactics 2 Talent Feedback: ${_fbCat}`);
