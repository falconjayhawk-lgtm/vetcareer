...
function renderFAQ() {
  return `
    ...
    <p style="color:#6b7280;font-size:14px;margin:0 0 24px">How VetCareer works, what it does with your data, and answers to common questions</p>
    ...
    ${faqSection('🏗️ How the App Works', [
      {
        q: 'What is the recommended order to use VetCareer?',
    ...
    ${faqSection('📤 Document Upload & Privacy', [
      {
        ...
        <ol style="margin:10px 0 4px;padding-left:20px;font-size:13px;line-height:2">
          ...
          <li>That structured data is returned and saved to your VetCareer profile</li>
          <li>The original file is <strong>never stored</strong> on VetCareer's servers</li>
        </ol>
      ...
      {
        q: 'Does VetCareer see my Social Security Number or other PII from my DD-214?',
    ...
    ${faqSection('🤖 AI Features & Quality', [
      ...
      },
      {
        ...
        a: `VetCareer limits AI requests to manage costs and ensure fair access. The current limits are <strong>50 standard AI requests per day</strong> (covers Resume, LinkedIn, Interview, Salary, etc.) and <strong>20 Job Scout searches per day</strong>. Limits reset at midnight UTC. If you hit a limit, you'll see a message and can resume the next day. These limits will be adjusted as the platform scales.`
      },
      {
    ...
    ${faqSection('💳 Account & Billing', [
      {
        q: 'Is VetCareer free?',
        a: `VetCareer is currently in beta. Beta users get full access to all features during the beta period. Paid tiers will be introduced before public launch — beta users will be notified in advance and may receive preferential pricing. We are committed to keeping VetCareer accessible to the veteran community.`
      },
      {
        q: 'How do I delete my account and data?',
        a: `Email <a href="mailto:privacy@vetcareer.com" style="color:#2563eb">privacy@vetcareer.com</a> with the subject line "Account Deletion Request" and your registered email address. We will delete your account and all associated data within 30 days and send confirmation. Note: AI-generated content you've downloaded (resumes, LinkedIn text, etc.) that is saved on your own device is not affected.`
      },
      {
        q: 'Who built VetCareer and why?',
        a: `VetCareer was built to address a real gap in job search tools — most applicant tracking systems and job boards penalize veterans for not having civilian keyword matches, even when their experience is directly applicable. VetCareer is designed to understand military experience on its own terms and translate it into language civilian employers recognize. The platform is built and operated by VetCareer LLC, a veteran-focused company.`
      }
    ])}
    ...
    <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:12px;padding:18px 20px;margin-top:8px;display:flex;gap:14px;align-items:center">
      ...
      <div>
        ...
        <div style="font-size:13px;color:#3b82f6">Use the <strong>Feedback</strong> button in the bottom-right corner of the app, or email us at <a href="mailto:support@vetcareer.com" style="color:#1d4ed8;font-weight:600">support@vetcareer.com</a></div>
      </div>
    </div>
  `;
}
